...
const TEST_DATA = {
    ...
    business: {
        ...
        phoneNumber: '+19801441675',
        businessType: client_1.BusinessType.SALON,
...
async function createTestServices(businessId) {
    ...
    const services = await Promise.all(TEST_DATA.services.map(async (serviceData) => {
...
main();
//# sourceMappingURL=create-whatsapp-test-business-1234.js.map