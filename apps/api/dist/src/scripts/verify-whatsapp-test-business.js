...
async function verifyTestBusiness() {
    ...
    try {
        ...
        if (!business) {
            ...
            console.log('💡 Run the create-whatsapp-test-business-1234.ts script first');
            return false;
        }
        ...
        console.log(`   • Clerk ID: ${business.owner.firebaseUid}`);
...
main();
//# sourceMappingURL=verify-whatsapp-test-business.js.map