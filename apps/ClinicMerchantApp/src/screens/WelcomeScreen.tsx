      ...
      <GradientView variant="dark" style={styles.gradient}>
        <View style={styles.content}>
          ...
          >
            ...
            <Text style={styles.tagline}>Streamline your clinic with smart appointments and seamless patient management</Text>
          </Animated.View>
          ...
          >
            ...
            <Text style={styles.footerText}>
              Join thousands of clinic owners who trust Salex
            </Text>
          </Animated.View>
        </View>
      </GradientView>
