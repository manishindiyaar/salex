...
// Fixed Clinic onboarding steps — no module gating, all steps always visible
const CLINIC_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  { id: 'resources',        label: 'Resources Setup',    completed: false },
  { id: 'staff',            label: 'Staff Setup',        completed: false },
