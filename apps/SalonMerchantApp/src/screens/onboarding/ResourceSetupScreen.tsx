...
const ResourceSetupScreen: React.FC<ResourceSetupScreenProps> = ({ navigation }) => {
  ...
  // Salon-first: always use Chair terminology from salonConfig
  const terminology = SALON_CONFIG.terminology;
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
              ...
              <Text style={styles.subtitle}>
                Add chairs for your salon — each chair handles one booking at a time
              </Text>
          ...
          >
            ...
            <View style={styles.section}>
              ...
              <View style={styles.examplesContainer}>
                {SALON_CONFIG.resourceExamples.map((example, index) => (
